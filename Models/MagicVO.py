...
# Model modified from https://github.com/ChiWeiHsiao/DeepVO-pytorch
...
class MagicVO(nn.Module):
    ...
    def forward(self, x):
        # x_rel: (batch, seq_len, channel, width, height)
        # stack_image
